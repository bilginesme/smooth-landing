module MyGame {
    ...
    export class Rhino extends Phaser.Sprite {
        ...
        normVelocity: number = 3;

        constructor(game: Phaser.Game, posInit: Phaser.Point) {
            super(game, posInit.x, posInit.y, 'rhino-spritesheet', 1);
            this.animations.add('rhinoWalking', [4, 5, 6], 1, true);
            this.animations.add('rhinoStopping', [0, 1, 2, 3], 1, true);
