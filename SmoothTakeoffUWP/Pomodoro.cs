    ...
    public class Pomodoro
    {
        ...
        public void AddOneSecond()
        {
            if (status == StatusEnum.Running)
                ...
                tsIdleTime = tsIdleTime.Add(tsDelta);
        ...
        public void BackToLife(DateTime theDayFromFile, int sliceNow, int numPomodorosToday, StateEnum state, int minutes, int seconds, int idleTimeHours, int idleTimeMinutes, int idleTimeSeconds)
        {
            if(theDayFromFile == theDay)
            {
                ...
                tsIdleTime = new TimeSpan(idleTimeHours, idleTimeMinutes, idleTimeSeconds);
            }
            else
            {
                Init(true);
        ...
        public bool IsDateDifferent()
        {
            return theDay != DateTime.Today;
            //return true;
        }
        ...
        public TimeSpan TSIdleTime { get { return tsIdleTime; } }
        #endregion
    }
}
